<?php
    ...
    if(isset($_POST['change'])){
        ...
        $sql = $connect->prepare("UPDATE `users` SET noti=false WHERE email='$email'");
        $sql->execute();
        print 'Notification Successfully Changed to FALSE!';
    ...
    <div id="abs-form">
        <div id="form2">
            ...
            <form action="notify-true.php" method="POST">
                ...
                <div><input type="email" name="email" Placeholder="Insert Email To Make Changes!" required></div><br>
